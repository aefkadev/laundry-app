...
@section('content')
  ...
  <div class="col-lg-12 col-lg-12 form-wrapper" id="tambah-jenislayanan">
      ...
      <h4 class="card-title"><a class="pr-3 text-dark" href="#"><i class="fa fa-arrow-left" aria-hidden="true"></i></a><b>Tambah Jenis</b></h4>
      ...
      <div class="card-body p-3 mb-2 bg-secondary text-white">      
          ...
          <div class="mb-3 pb-4 row">
            <label class="col-sm-3 col-form-label">Nama Pejenislayanan : </label>
            <div class="col-sm-9">
